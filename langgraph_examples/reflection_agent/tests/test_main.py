...
class TestEventLoop:
    ...
    def test_state_with_tool_messages_exceeding_max_iterations_returns_end(self):
    ...
    def test_state_at_max_iterations_boundary(self):
    ...
    def test_last_message_without_tool_calls_returns_end(self):
    ...
    def test_last_message_with_empty_tool_calls_returns_end(self):
    ...
    def test_last_message_with_tool_calls_returns_execute_tools(self):
    ...
    def test_multiple_ai_messages_only_last_matters(self):
    ...
    def test_finds_last_ai_message_with_tool_calls_attribute(self):
    ...
    def test_mixed_messages_last_ai_has_tools(self):
    ...
    def test_edge_case_exactly_max_iterations_plus_one(self):
...
class TestEventLoopIntegration:
    ...
    def test_event_loop_returns_valid_edge_names(self):
    ...
    def test_max_iterations_constant_is_positive(self):
